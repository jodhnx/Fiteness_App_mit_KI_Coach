...
import { Dumbbell, Flame, TrendingDown, TrendingUp, Minus, ChevronRight } from "lucide-react";
...
export const HomeWeekOverviewCard = memo(function HomeWeekOverviewCard({
  home,
  streakDays = 0,
}: Props) {
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        <WeekStat
          ...
          sub={streakDays > 0 ? "Tage" : "noch keiner"}
