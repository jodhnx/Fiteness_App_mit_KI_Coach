...
function miscAchievements(): AchievementSeed[] {
  return [
    ...
    },
    {
      slug: "pr-5",
      name: "5 Rekorde",
      description: "5 Personal Records gesetzt",
      icon: "🥈",
      xpReward: 100,
      category: "training",
      tier: "silver",
    ...
    {
      slug: "progress-photo-1",
      name: "Erstes Fortschrittsfoto",
      description: "Erstes Progress-Foto hochgeladen",
      icon: "📷",
      xpReward: 60,
      category: "weight",
      tier: "bronze",
      targetValue: 1,
      metricKey: "progress_photos",
      sortOrder: 510,
    },
    {
      slug: "progress-photo-5",
      name: "5 Fortschrittsfotos",
      description: "5 Progress-Fotos hochgeladen",
      icon: "📸",
      xpReward: 120,
      category: "weight",
      tier: "silver",
    ...
    },
    {
      slug: "recipe-first",
      name: "Erstes Rezept",
      description: "Eigenes Rezept erstellt",
      icon: "👨‍🍳",
      xpReward: 50,
      category: "nutrition",
      tier: "bronze",
      targetValue: 1,
      metricKey: "recipes_created",
      sortOrder: 280,
    },
    {
      slug: "profile-setup",
      name: "Profil eingerichtet",
      description: "Kalorienziel und Gewicht hinterlegt",
      icon: "✅",
      xpReward: 40,
      category: "level",
      tier: "bronze",
      targetValue: 1,
      metricKey: "profile_complete",
      sortOrder: 5,
    },
    ...([3, 7, 14, 30, 50, 100] as const).map((n, i) => ({
      slug: `active-days-${n}`,
      name: `${n} aktive Tage`,
      description: `${n} Tage mit Aktivität (Streak)`,
      icon: n >= 50 ? "💎" : "📅",
      xpReward: 20 + n,
      category: "streak",
      tier: tierForIndex(i, 6),
      targetValue: n,
      metricKey: "active_streak_days",
      sortOrder: 180 + i,
    })),
...
export const ACHIEVEMENT_CATEGORIES = [
  ...
  { id: "weight", label: "Progress", icon: "⚖️" },
  { id: "activity", label: "Consistency", icon: "🚶" },
  { id: "level", label: "Milestones", icon: "⭐" },
